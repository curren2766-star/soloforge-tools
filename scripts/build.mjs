...
page('', 'PC・動画制作の無料ツール集', 'モニターPPI比較、グラボ交換の電源容量、4K・高Hzの接続条件、OBS録画容量をブラウザですぐ確認。無料・ログイン不要のSOLOFORGE Tools。', `
<section class="home-hero"><div class="eyebrow">PC & CREATOR UTILITIES</div><p class="site-name">SOLOFORGE Tools</p><h1>小さな面倒を、<br><span>すぐ終わらせる。</span></h1><p class="lead">モニター選びも、グラボ交換も、録画の容量も。<br>調べて、計算して、迷う時間をひとつ減らそう。</p><div class="trust-line"><span>無料で使える</span><span>ログイン不要</span><span>ブラウザ内で計算</span></div></section>
<section id="tools"><div class="section-heading"><h2>いま使えるツール</h2><span class="muted">04 TOOLS</span></div><div class="tool-cards">
<a class="card tool-card featured" href="monitor-ppi/"><div class="card-top"><span class="tool-number">04 / MONITOR PPI</span><span class="badge">NEW</span></div><div class="card-metric" aria-hidden="true">A <span>vs</span> B</div><h3>モニターPPI<br>比較計算機</h3><p>買い替えると、画面の細かさは何％変わる？</p><p class="muted">現在と購入候補のインチ・解像度から、PPIとピクセルピッチの差を比較します。</p><span class="card-cta">画素密度を比較 <span aria-hidden="true">↗</span></span></a>
...
writeFileSync('sitemap.xml', `<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n${['', 'monitor-ppi/', 'gpu-psu/', 'display-bandwidth/', 'obs-storage/', ...Object.keys(info).filter(p => p !== '404.html')].map(path => `  <url><loc>${base}${path}</loc></url>`).join('\n')}\n</urlset>\n`);
console.log('Built 10 static pages and sitemap.');
